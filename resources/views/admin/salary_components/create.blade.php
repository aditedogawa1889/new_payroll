            ...
            <div class="card-body p-6">
                ...
                <div class="mb-4">
                    ...
                    <select name="component_parameter" id="component_parameter" class="w-full rounded-md border-gray-300 shadow-sm focus:border-adminlte-primary focus:ring-adminlte-primary sm:text-sm transition-colors" required>
                        <option value="general" {{ old('component_parameter', 'general') == 'general' ? 'selected' : '' }}>General (Nominal langsung)</option>
                        <option value="percentage" {{ old('component_parameter') == 'percentage' ? 'selected' : '' }}>Persentase (Persentase dari komponen tertentu)</option>
                        <option value="custom" {{ old('component_parameter') == 'custom' ? 'selected' : '' }}>Custom (Formula hitungan khusus)</option>
                    </select>
                </div>
